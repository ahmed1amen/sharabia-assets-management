...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('engineer') }}'><i class='nav-icon fa fa-user-tie'></i> المهندسين </a></li>
...
<li class='nav-item'><a class='nav-link' href='#'><i class='nav-icon fa fa-chart-area'></i> التقارير</a></li>
